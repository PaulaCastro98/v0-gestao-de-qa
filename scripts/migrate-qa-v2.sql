...
-- Remover todas as tabelas antigas e dependências
...
CREATE INDEX idx_historias_sprint ON historias(sprint);
CREATE INDEX idx_historias_status ON historias(status);
CREATE INDEX idx_casos_teste_historia ON casos_teste(historia_id);
CREATE INDEX idx_casos_teste_status ON casos_teste(status_teste);
CREATE INDEX idx_bugs_caso_teste ON bugs(caso_teste_id);
CREATE INDEX idx_evidencias_bug ON evidencias(bug_id);
