  ...
  try {
    ...
    const result = await sql`
      INSERT INTO test_executions (
        ...
        tipo_teste, status_teste, prioridade_teste, criticidade_defeito, ambiente,
        bug_id, observacoes, reaberto, status_automacao, flaky, created_at, updated_at
      ) VALUES (
        ${sanitizedData.feature}, ${sanitizedData.historia_git}, ${sanitizedData.story_points}, ${sanitizedData.sprint}, ${sanitizedData.status_hu}, ${sanitizedData.tc_id}, ${sanitizedData.titulo_tc},
        ${sanitizedData.tipo_teste}, ${sanitizedData.status_teste}, ${sanitizedData.prioridade_teste}, ${sanitizedData.criticidade_defeito}, ${sanitizedData.ambiente},
        ${sanitizedData.bug_id}, ${sanitizedData.observacoes}, ${sanitizedData.reaberto}, ${sanitizedData.status_automacao}, ${sanitizedData.flaky}, NOW(), NOW()
      )
      RETURNING *
    `
