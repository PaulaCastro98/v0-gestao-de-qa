  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        // Mantido o seletor simplificado da última vez
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          // ✅ Corrigido: min-w-[8rem] -> min-w-32
          // ✅ Mantido h-[var(...)] e min-w-[var(...)] com var()
          'min-w-32', // Substituído min-w-[8rem]
          'h-[var(--radix-select-content-available-height)]', // Manter com var()
          'min-w-[var(--radix-select-trigger-width)]', // Manter com var()
          className,
        )}
        position={position}
        {...props}
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "*:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className,
      )}
      {...props}
    >
